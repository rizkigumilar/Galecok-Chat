...
import MenuBar from '../components/MenuBarChat';
        ...
        return (
            <Container>
                ...
                <Header style={{ backgroundColor: '#05A0E4' }}>
                    ...
                    <Right>
                        <Button transparent >
                            <Image source={{ uri: this.state.foto }} style={{ height: 35, width: 35, borderRadius: 100 / 2, right: 80 }} />
                        </Button>
                        <Title style={{ fontSize: 20, fontWeight: 'bold', right: 80, bottom: 15 }}>{this.state.name}</Title>
                        <Subtitle style={{ fontSize: 12.5, color: 'white', right: 130 }} numberOfLines={1}>{this.state.status}</Subtitle>
